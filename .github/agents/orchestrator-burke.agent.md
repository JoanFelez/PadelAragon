---
name: Orchestrator-Burke
description: Sonnet, Codex, Gemini
model: Claude Opus 4.6 (copilot)
tools: ['read/readFile', 'agent', 'vscode/memory', 'terminal']
---
...
- **Coder-A** — Writes code, fixes bugs, implements logic
- **Coder-B** — Writes code, fixes bugs, implements logic
- **Coder-C** — Writes code, fixes bugs, implements logic
- **Coder-D** — Writes code, fixes bugs, implements logic
